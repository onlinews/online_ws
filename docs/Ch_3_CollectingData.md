...
The participant we wish to send it to, will fill out the `participant` filed they way they feel comfortable with, and might also edit the pre-filled `sessions` field.
